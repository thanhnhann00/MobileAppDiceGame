                ...
                int numDice = args.getInt("numDice");
                    switch (numDice) {
                        case (1): {
                            ...
                            final String rollResult = "Rolled a D8 " + ": " + (dice1);
                        ...
                        case (2): {
                            ...
                            // Add the total of both dice to the history using ViewModel
                            final String rollResult = "Rolled 2D8: " + dice1 +" + "+ dice2  + " = "  + (dice1 + dice2);
                            requireActivity().runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    viewModel.addToDiceRollHistory(rollResult);
                        ...
                        case (3): {
                            ...
                            // Add the total of both dice to the history using ViewModel
                            final String rollResult = "Rolled 3D8: " + dice1 +" + "+ dice2 + " + "+ dice3 + " = "  + (dice1 + dice2+ dice3);
                            requireActivity().runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    viewModel.addToDiceRollHistory(rollResult);
